        ...
        <div class="row">
                <div class = "col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" id="birth_date" name="birth_date" value="{{ isset($client) ? $client->birth_date : old('birth_date') }}">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="date_entry">Fecha de Ingreso:</label>
                        <input type="date" class="form-control" id="date_entry" name="date_entry" value="{{ isset($clientDate) ? $clientDate->date_entry : date('Y-m-d') }}">
                    </div>
                    <div class="mb-3">
